# Jaeger Setup
The command below is for testing environment only. For more details check link https://github.com/jaegertracing/jaeger-openshift.
oc process -f https://raw.githubusercontent.com/jaegertracing/jaeger-openshift/master/all-in-one/jaeger-all-in-one-template.yml | oc create -f -


Jaeger GUI can be found with command:
